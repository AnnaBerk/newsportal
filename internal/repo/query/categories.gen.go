...
func newCategory(db *gorm.DB, opts ...gen.DOOption) category {
	...
	_category.CategoryID = field.NewInt32(tableName, "categoryId")
	_category.Title = field.NewString(tableName, "title")
	_category.OrderNumber = field.NewInt32(tableName, "orderNumber")
	_category.StatusID = field.NewInt32(tableName, "statusId")
...
func (c *category) updateTableName(table string) *category {
	...
	c.CategoryID = field.NewInt32(table, "categoryId")
	c.Title = field.NewString(table, "title")
	c.OrderNumber = field.NewInt32(table, "orderNumber")
	c.StatusID = field.NewInt32(table, "statusId")
...
func (c *category) fillFieldMap() {
	...
	c.fieldMap["orderNumber"] = c.OrderNumber
	c.fieldMap["statusId"] = c.StatusID
}
