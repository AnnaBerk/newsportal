...
func newStatus(db *gorm.DB, opts ...gen.DOOption) status {
	...
	_status.StatusID = field.NewInt32(tableName, "statusId")
...
func (s *status) updateTableName(table string) *status {
	...
	s.StatusID = field.NewInt32(table, "statusId")
...
func (s status) Columns(cols ...field.Expr) gen.Columns { return s.statusDo.Columns(cols...) }
...
func (s *status) fillFieldMap() {
	...
	s.fieldMap["statusId"] = s.StatusID
}
