...
func newTag(db *gorm.DB, opts ...gen.DOOption) tag {
	...
	_tag.TagID = field.NewInt32(tableName, "tagId")
	_tag.Title = field.NewString(tableName, "title")
	_tag.StatusID = field.NewInt32(tableName, "statusId")
...
func (t *tag) updateTableName(table string) *tag {
	...
	t.TagID = field.NewInt32(table, "tagId")
	t.Title = field.NewString(table, "title")
	t.StatusID = field.NewInt32(table, "statusId")
...
func (t *tag) fillFieldMap() {
	...
	t.fieldMap["tagId"] = t.TagID
	t.fieldMap["title"] = t.Title
	t.fieldMap["statusId"] = t.StatusID
}
