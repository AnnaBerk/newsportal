...
func newNews(db *gorm.DB, opts ...gen.DOOption) news {
	...
	_news.NewsID = field.NewInt32(tableName, "newsId")
	_news.Title = field.NewString(tableName, "title")
	_news.Foreword = field.NewString(tableName, "foreword")
	_news.Content = field.NewString(tableName, "content")
	_news.PublicationDate = field.NewTime(tableName, "publicationDate")
	_news.CategoryID = field.NewInt32(tableName, "categoryId")
	_news.TagIds = field.NewString(tableName, "tagIds")
	_news.CreatedAt = field.NewTime(tableName, "createdAt")
	_news.StatusID = field.NewInt32(tableName, "statusId")
...
type news struct {
	...
	NewsID          field.Int32
	Title           field.String
	Foreword        field.String
	Content         field.String
	PublicationDate field.Time
...
func (n *news) updateTableName(table string) *news {
	...
	n.NewsID = field.NewInt32(table, "newsId")
	n.Title = field.NewString(table, "title")
	n.Foreword = field.NewString(table, "foreword")
	n.Content = field.NewString(table, "content")
	n.PublicationDate = field.NewTime(table, "publicationDate")
	n.CategoryID = field.NewInt32(table, "categoryId")
	n.TagIds = field.NewString(table, "tagIds")
	n.CreatedAt = field.NewTime(table, "createdAt")
	n.StatusID = field.NewInt32(table, "statusId")
...
func (n *news) fillFieldMap() {
	...
	n.fieldMap["newsId"] = n.NewsID
	n.fieldMap["title"] = n.Title
	n.fieldMap["foreword"] = n.Foreword
	n.fieldMap["content"] = n.Content
	n.fieldMap["publicationDate"] = n.PublicationDate
	n.fieldMap["categoryId"] = n.CategoryID
	n.fieldMap["tagIds"] = n.TagIds
	n.fieldMap["createdAt"] = n.CreatedAt
	n.fieldMap["statusId"] = n.StatusID
}
